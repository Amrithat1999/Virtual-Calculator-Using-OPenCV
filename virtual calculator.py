...
class Button:
    ...
    def checkclick(self,i,j):
        if self.pos[0]<i<self.pos[0]+self.width and \
            ...
            cv.rectangle(frame, self.pos, (self.pos[0] + self.width, self.pos[1] + self.height), (255, 255, 255),
                         cv.FILLED)
            cv.rectangle(frame, self.pos, (self.pos[0] + self.width, self.pos[1] + self.height), (50, 50, 50), 3)
...
while True:
    ...
    cv.putText(frame, myequation, (810,120), cv.FONT_HERSHEY_PLAIN, 3, (50, 50, 50), 3)
    #image show
